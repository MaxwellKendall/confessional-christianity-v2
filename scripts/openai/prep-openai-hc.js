...
const PATH = 'three-forms-of-unity/heidelberg-catechism.json';
...
const main = async () => {
  ...
  stream.on('end', () => {
    const parsed = JSON.parse(data).content.filter(removeLordsDays).map(prepData);
